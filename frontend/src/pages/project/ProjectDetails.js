        ...
        <>
            <div className="bg-white p-4 rounded-md shadow-md">
                ...
                <div className="grid grid-cols-3 gap-4 mb-4">
                    <div>
                        <h2 className="text-gray-600 font-semibold">Project Description</h2>
                    ...
                    <div>
                        <h2 className="text-gray-600 font-semibold">Project Type</h2>
                        <p className="text-gray-700">{project.type}</p>
                    </div>
                    <div className="col-span-3">
                        <h2 className="text-gray-600 font-semibold">Project Scope</h2>
                    ...
                    <div>
                        <h2 className="text-gray-600 font-semibold">Project Status</h2>
                        <span className="bg-green-200 text-green-800 px-2 py-1 rounded-md">
                            {project.projectStatus}
                        </span>
                    </div>
                    <div>
                        <h2 className="text-gray-600 font-semibold">Time Spent</h2>
                        <p className="text-gray-700">{project.timeSpent}</p>
                    </div>
                    <div>
                        <h2 className="text-gray-600 font-semibold">Max Time Planned</h2>
                        <p className="text-gray-700">{project.maxTimePlanned}</p>
                    </div>
                    <div>
                        <h2 className="text-gray-600 font-semibold">Time Billable</h2>
                        <p className="text-gray-700">{project.timeBillable}</p>
                    </div>
                    <div>
                        <h2 className="text-gray-600 font-semibold">Project Code</h2>
                    ...
                    <div className="grid grid-cols-4 gap-4">
                        <div className="bg-gray-100 p-3 rounded-md">
                            ...
                            <div className="text-gray-700 flex gap-1">
                                <p className="text-xl"> <CiCalendar /></p>
                                <p className="font-bold">{moment(project?.estimatedStartDate).format("MMM, DD, YYYY")}</p>
                            </div>
                        </div>
                        <div className="bg-gray-100 p-3 rounded-md">
                            <h2 className="text-gray-600 font-semibold">
                            ...
                            <div className="text-gray-700 flex gap-1">
                                ...
                                <p className="font-bold">{moment(project?.estimatedEndDate).format("MMM, DD, YYYY")}</p>
                            </div>
                        </div>
                        <div className="bg-gray-100 p-3 rounded-md">
                            ...
                            <div className="text-gray-700 flex gap-1">
                                <p className="text-xl"> <CiCalendar /></p>
                                <p className="font-bold">{moment(project?.actualStartDate).format("MMM, DD, YYYY")}</p>
                            </div>
                        </div>
                        <div className="bg-gray-100 p-3 rounded-md">
                            ...
                            <div className="text-gray-700 flex gap-1">
                                ...
                                <p className="font-bold">{moment(project?.actualEndDate).format("MMM, DD, YYYY")}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="mb-4">
                        ...
                        <div className="grid grid-cols-6 gap-3">
                            ...
                            <div className="bg-red-200 text-red-800 p-4 rounded-md">
                                ...
                                <p className="text-xl">{project?.qassure?.open
                                    || 0}</p>
                            </div>
                ...
                <div className="bg-white p-4 rounded-md shadow-md mt-3 w-1/3 ml-2">
                    <div className="mb-4">
                        ...
                        <div className="bg-gray-100 p-4 rounded-md">
                            ...
                            <button className="text-blue-600 hover:underline">Read All</button>
                        </div>
                    </div>
                </div>
            </div>
