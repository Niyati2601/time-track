          ...
          <div className='w-1/2'>
            ...
            <div className="mb-4">
              <label className="flex items-center">
                ...
                />
                <span className="ml-2 font-semibold mt-1">Send Anonymously</span>
              </label>
        ...
        <div className="mt-4 bg-white shadow-lg rounded-md p-8">
          {data.length > 0 ? (
            data && data.map((feedback, index) => (
              ...
              >
                <div>
                  <p className={`text-xl font-semibold ${feedback.type === 'general' ? 'text-green-500' : 'text-red-500'}`}>Feedback Type : {feedback.type}</p>
                  {feedback.projectName ?  <p className="text-md">Project Name : {feedback.projectName}</p> : null}
                  {feedback.employee ? <p className="text-md">Employee : {feedback.employee}</p> : null}
