  ...
  return (
    ...
    {activeTab === "send" && (
      <div className="mt-4 bg-white shadow-lg rounded-md p-8 flex">
        ...
        <div className="w-1/2">
          <div className="mt-10 m-auto w-full flex items-center p-10">
            ...
            >
              <div className="w-full">
                <div className="flex justify-between">
                  ...
                  <span className="flex mt-1 gap-0.5">
                    {[...Array(5)].map((_, index) => (
                      <svg
                        key={index}
                        className={`h-8 w-8 shrink-0 cursor-pointer ${
                ...
                {feedback.employee && (
                  <p className="text-md"><b>Employee:</b> {feedback.employee}</p>
                )}
                <p><b>Description:</b> {feedback.description}</p>
              </div>
            </div>
          ))
        ) : (
          ...
          receivedData.map((feedback, index) => (
            ...
            >
              <div className="w-full">
                ...
                {feedback.employee && (
                  <p className="text-md"><b>Employee:</b> {feedback.isAnonymous ? "Anonymous" : feedback.username}</p>
                )}
                <p><b>Description:</b> {feedback.description}</p>
              </div>
            </div>
