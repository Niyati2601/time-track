...
const TimelogEditor = ({ onOpen, onClose }) => {
  ...
  return (
    onOpen && (
      <div className="timelog-popup fixed bg-green-500 p-4 rounded-lg shadow-lg z-50 w-[400px] bottom-20 right-28">
        ...
        <div className="mt-4 flex justify-between">
          ...
          <div className="p-2 border border-dashed rounded-full">
            <FiTag className="text-xl text-white cursor-pointer " />
          </div>
        </div>
      </div>
    )
